...
#
file_path = '/Users/linbojun/Library/CloudStorage/OneDrive-共用文件庫－onedrive/Oceanic Fisheries Ecosystem Laboratory/ENSO_LL/Data/northern_alb_model_data.csv'

# 
northern_alb_model_data = pd.read_csv(file_path)

X = northern_alb_model_data.iloc[:, 11:46]
y = northern_alb_model_data.iloc[:, 0]
...
scores_df.to_csv('rfecv_cv_results_alb_southern.csv', index=False)
